...
可以看到一些已经定义好的加载点:
<a href="{{site.url}}/media/pub/linux/disk-info.jpg" alt="fstab" rel="prettyPhoto[{{page.UUID}}]">
...
<a href="{{site.url}}/media/pub/linux/disk-info-2.jpg" alt="fstab-info" rel="prettyPhoto[{{page.UUID}}]">
