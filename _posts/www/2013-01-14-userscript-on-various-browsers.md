...
<img src="http://demi-panda.com/media/pub/web/Greasemonkey.jpg" width="560px"  alt="Greasemonkey" ></img>
</li>

<li>
打开工具-找到附加组件就可以看到自己安装的用户脚本管理工具
<img src="http://demi-panda.com/media/pub/web/userscript.jpg" width="560px"  alt="Greasemonkey" ></img>
</li>
<li>
添加用户脚本
<img src="http://demi-panda.com/media/pub/web/add-userscript.jpg" width="560px"  alt="Greasemonkey" ></img>
</li>
</ol>
