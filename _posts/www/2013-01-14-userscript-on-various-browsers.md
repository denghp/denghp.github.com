...
<img src="{{site.static_url}}/assets/images/web/Greasemonkey.jpg" width="530px"  alt="Greasemonkey" ></img>
</li>

<li>
打开工具-找到附加组件就可以看到自己安装的用户脚本管理工具
<img src="{{site.static_url}}/assets/images/web/userscript.jpg" width="530px"  alt="Greasemonkey" ></img>
</li>
<li>
添加用户脚本<br>
<img src="{{site.static_url}}/assets/images/web/add-userscript.jpg" width="530px"  alt="Greasemonkey" ></img>
</li>
</ol>
