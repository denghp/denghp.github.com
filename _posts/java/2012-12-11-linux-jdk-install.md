...
<img src="{{site.static_url}}/assets/images/java/jdk-1.jpg" width="480px" alt="jdk-info"></img>
</li>
<li>选择自己需要指定的java版本<br>
<img src="{{site.static_url}}/assets/images/java/jdk-2.jpg" width="480px" alt="jdk-info"></img>
</li>
</ol>
