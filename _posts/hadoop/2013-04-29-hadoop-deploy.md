...
<a href="{{site.url}}/media/pub/linux/hadoop-format.jpg" alt="hadoop namenode -format" rel="prettyPhoto[{{page.UUID}}]">
  <img src="/media/pub/linux/hadoop-format.jpg" width="560px"  alt="hadoop namenode format" />
</a>

namenode -format 这是第一需要做的初始化之后产生如下文件:
<a href="{{site.url}}/media/pub/linux/hadoop-namenode-format.jpg" alt="hadoop namenode -format" rel="prettyPhoto[{{page.UUID}}]">
  <img src="/media/pub/linux/format-files.jpg" width="330px"  alt="namenode format" />
</a>
...
<a href="{{site.url}}/media/pub/linux/namenode-web.jpg" alt="hadoop namenode web" rel="prettyPhoto[{{page.UUID}}]">
  <img src="/media/pub/linux/namenode-web.jpg" width="560px"  alt="namenode web" />
</a>

<strong>Jobtracker</strong>
<a href="{{site.url}}/media/pub/linux/jobtracker-web.jpg" alt="jobtracker web" rel="prettyPhoto[{{page.UUID}}]">
  <img src="/media/pub/linux/jobtracker-web.jpg" width="560px"  alt="jobtracker web" />
</a>
...
<a href="{{site.url}}/media/pub/linux/hadoop-mapreduce.jpg" alt="hadoop mapreduce" rel="prettyPhoto[{{page.UUID}}]">
  <img src="/media/pub/linux/hadoop-mapreduce.jpg" width="560px"  alt="hadoop mapreduce" />
</a>
